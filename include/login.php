...
<div style="padding-top: 5%;"  class="login-box">
  <div class="card">
    ...
    <div class="card-body">
      ...
      <span style="font-size: 40px; font-w:bold; margin: 10px;">CAHYA HOTSPOT</span>
      </div>
      <form autocomplete="on" action="" method="post">
      <table class="table">
        <tr>
          <td class="align-middle text-center">
            <input class="form-control" type="text" name="user" placeholder="Username" value="0" required="1" autofocus>
          </td>
        </tr>
        <tr>
          <td class="align-middle text-center">
            <input class="form-control" type="password" name="pass" placeholder="Password" value="0" required="1">
          </td>
        </tr>
        <tr>
          <td class="align-middle text-center">

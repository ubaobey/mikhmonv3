...
<div style="padding:0px;border-bottom:1px solid;text-align:center;font-weight:bold;font-size:10px;color:<?php echo $color ?>">Cs:085366567572</div>
<?php if($usermode == "vc"){?> 
...
<b>Login/logout mks.net</b><span id="num"><?php echo " [$num]";?>
</div>
<!--mks-cs-akhir-->	
</td>
</tr>

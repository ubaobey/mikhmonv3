...
<div style="clear:both;color:#555;margin-top:2px;margin-left:24px;margin-bottom:2.5px;">
<?php if($v_opsi=='up'){ ?>
<?php }else{ ?>
...
<div style="padding:0px;border-bottom:1px solid<?php echo $color ?>;text-align:center;font-size:16px;font-family:courier prime code;font-weight:bold;color:#000000;"><?php echo $username;?></div>
<?php } ?>
</div>
